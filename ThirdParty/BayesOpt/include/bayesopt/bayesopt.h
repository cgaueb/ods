...
extern "C" {
  ...
  BAYESOPT_API void createOptimizer(void*& handle, bopt_params parameters, int numDims, const double* lb, const double* ub);
  BAYESOPT_API void releaseOptimizer(void*& handle);

  BAYESOPT_API void initOptimizerContinuous(void* handle, const double* const* X, const double* y, int numPoints);
  BAYESOPT_API void generateLHSamples(void* handle, double** X, int numSamples, int numDims);
  BAYESOPT_API void argMin(void* handle, double* x);
  BAYESOPT_API void minValue(void* handle, double* x);
  BAYESOPT_API bool OptAcquisition(void* handle, double* x);
  BAYESOPT_API void updateOptimizer(void* handle, const double* xi, const double y);
  BAYESOPT_API void getDistribution(void* handle, const double* xi, double* mu, double* std);
  BAYESOPT_API int viewLog(void* handle, const char*& log);
  BAYESOPT_API void attachLog(void* handle);
